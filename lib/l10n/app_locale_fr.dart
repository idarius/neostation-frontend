...
const Map<String, dynamic> appLocaleFr = {
  ...
  AppLocale.searchEmptyHint: 'Tapez pour rechercher dans tous les systèmes',
  AppLocale.searchNoResults: 'Aucun jeu trouvé pour « {query} »',
  AppLocale.searchMinLength: 'Tapez au moins 2 caractères',
  ...
  AppLocale.scrapeDialogTitle: 'Scraper avec un nom personnalisé',
  AppLocale.scrapeDialogHelper:
      "Modifiez le nom de recherche si ScreenScraper n'a pas trouvé le jeu",
  AppLocale.scrapeDialogSubmit: 'Rechercher',
  AppLocale.scrapeDialogReset: 'Réinitialiser',
  ...
  AppLocale.smbSyncProviderName: 'Réseau',
  AppLocale.smbSyncProviderSubtitle: 'NAS via SMB',
  AppLocale.smbSyncStatusConnected: 'Connecté',
  AppLocale.smbSyncStatusDisconnected: 'Déconnecté',
  AppLocale.smbSyncStatusError: 'Erreur : {error}',
  AppLocale.smbSyncFormHost: 'Hôte / IP',
  AppLocale.smbSyncFormShare: 'Partage',
  AppLocale.smbSyncFormSubdir: 'Sous-dossier',
  AppLocale.smbSyncFormUser: 'Utilisateur',
  AppLocale.smbSyncFormDomain: 'Domaine',
  AppLocale.smbSyncFormPassword: 'Mot de passe',
  AppLocale.smbSyncBtnTest: 'Tester la connexion',
  AppLocale.smbSyncBtnSave: 'Enregistrer & activer',
  AppLocale.smbSyncBtnSyncNow: 'Sauvegarder maintenant',
  AppLocale.smbSyncBtnList: 'Lister les saves',
  AppLocale.smbSyncErrAuth: 'Identifiants incorrects',
  AppLocale.smbSyncErrUnreachable: 'Hôte injoignable',
  AppLocale.smbSyncErrShareNotFound: 'Partage introuvable',
  AppLocale.smbSyncErrTimeout: 'Temps de connexion dépassé',
  AppLocale.smbSyncErrUnknown: 'Erreur SMB : {error}',
