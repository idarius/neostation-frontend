...
class EventListener {
    ...
    private val supportedAxes = listOf(
        ...
        SupportedAxis(MotionEvent.AXIS_RX),      // Alternative right stick X (some generic controllers)
        SupportedAxis(MotionEvent.AXIS_RY, invert = true), // Alternative right stick Y
